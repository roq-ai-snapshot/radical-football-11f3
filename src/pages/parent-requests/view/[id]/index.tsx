...
import { getParentRequestById } from 'apiSdk/parent-requests';
...
function ParentRequestViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Parent Request Detail View
          </Text>
          {hasAccess('parent_request', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/parent-requests/edit/${data?.id}`} passHref legacyBehavior>
              <Button
